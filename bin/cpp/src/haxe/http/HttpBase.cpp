...
HX_LOCAL_STACK_FRAME(_hx_pos_9080cebb9fb05943_85_setHeader,"haxe.http.HttpBase","setHeader",0xf9141ad8,"haxe.http.HttpBase.setHeader","/usr/share/haxe/std/haxe/http/HttpBase.hx",85,0xf812b1ec)
HX_LOCAL_STACK_FRAME(_hx_pos_9080cebb9fb05943_142_setPostData,"haxe.http.HttpBase","setPostData",0x36d5f0b5,"haxe.http.HttpBase.setPostData","/usr/share/haxe/std/haxe/http/HttpBase.hx",142,0xf812b1ec)
...
void HttpBase_obj::setHeader(::String name,::String value){
            	HX_STACKFRAME(&_hx_pos_9080cebb9fb05943_85_setHeader)
HXLINE(  86)		{
HXLINE(  86)			int _g = 0;
...
void HttpBase_obj::setPostData(::String data){
            	HX_STACKFRAME(&_hx_pos_9080cebb9fb05943_142_setPostData)
