...
bool Http_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3f4ecf35) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x3f4ecf35;
	} else {
		return inClassId==(int)0x461c056b;
	}
}
...
HXLINE( 147)							::Array< ::String > b2 = b->b;
HXDLIN( 147)							b2->push(::Std_obj::string(x));
            						}
            					}
HXLINE( 148)					{
...
HXLINE( 151)							::Array< ::String > b3 = b->b;
HXDLIN( 151)							b3->push(::Std_obj::string(x1));
            						}
            					}
HXLINE( 152)					{
...
HXLINE( 155)					::Array< ::String > b4 = b->b;
HXDLIN( 155)					b4->push(::Std_obj::string(boundary));
            				}
            			}
HXLINE( 156)			{
...
HXLINE( 158)			{
HXLINE( 158)				::String x2 = ( (::String)(this->file->__Field(HX_("param",8d,80,55,bd),hx::paccDynamic)) );
HXDLIN( 158)				if (hx::IsNotNull( b->charBuf )) {
HXLINE( 158)					b->flush();
            				}
HXDLIN( 158)				if (hx::IsNull( b->b )) {
HXLINE( 158)					b->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            				}
            				else {
HXLINE( 158)					::Array< ::String > b5 = b->b;
HXDLIN( 158)					b5->push(::Std_obj::string(x2));
            				}
            			}
HXLINE( 159)			{
...
HXLINE( 160)			{
HXLINE( 160)				::String x3 = ( (::String)(this->file->__Field(HX_("filename",c7,2e,6a,77),hx::paccDynamic)) );
HXDLIN( 160)				if (hx::IsNotNull( b->charBuf )) {
HXLINE( 160)					b->flush();
            				}
HXDLIN( 160)				if (hx::IsNull( b->b )) {
HXLINE( 160)					b->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            				}
            				else {
HXLINE( 160)					::Array< ::String > b6 = b->b;
HXDLIN( 160)					b6->push(::Std_obj::string(x3));
            				}
            			}
HXLINE( 161)			{
...
HXLINE( 163)			{
HXLINE( 163)				::String x4 = ( (::String)((((HX_("Content-Type: ",f4,2b,e6,1d) + this->file->__Field(HX_("mimeType",8e,56,09,5d),hx::paccDynamic)) + HX_("\r\n",5d,0b,00,00)) + HX_("\r\n",5d,0b,00,00))) );
HXDLIN( 163)				if (hx::IsNotNull( b->charBuf )) {
HXLINE( 163)					b->flush();
            				}
HXDLIN( 163)				if (hx::IsNull( b->b )) {
HXLINE( 163)					b->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            				}
            				else {
HXLINE( 163)					::Array< ::String > b7 = b->b;
HXDLIN( 163)					b7->push(::Std_obj::string(x4));
            				}
            			}
...
HXDLIN( 166)			::Array< ::Dynamic> _g11 = this->params;
HXDLIN( 166)			while((_g2 < _g11->length)){
HXLINE( 166)				 ::Dynamic p1 = _g11->__get(_g2);
...
HXLINE( 171)				::String uri1 = (::StringTools_obj::urlEncode(( (::String)(p1->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)) )) + HX_("=",3d,00,00,00));
HXDLIN( 171)				uri = (uri + (uri1 + ::StringTools_obj::urlEncode(( (::String)((HX_("",00,00,00,00) + p1->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic))) ))));
            			}
            		}
HXLINE( 175)		 ::haxe::io::BytesOutput b8 =  ::haxe::io::BytesOutput_obj::__alloc( HX_CTX );
HXLINE( 176)		if (hx::IsNotNull( method )) {
HXLINE( 177)			b8->writeString(method,null());
HXLINE( 178)			b8->writeString(HX_(" ",20,00,00,00),null());
            		}
            		else {
HXLINE( 179)			if (post) {
HXLINE( 180)				b8->writeString(HX_("POST ",c0,87,85,44),null());
            			}
            			else {
HXLINE( 182)				b8->writeString(HX_("GET ",ea,ca,22,2f),null());
            			}
            		}
HXLINE( 184)		if (hx::IsNotNull( ::sys::Http_obj::PROXY )) {
HXLINE( 185)			b8->writeString(HX_("http://",52,75,cd,5a),null());
HXLINE( 186)			b8->writeString(host,null());
HXLINE( 187)			if (hx::IsNotEq( port,80 )) {
HXLINE( 188)				b8->writeString(HX_(":",3a,00,00,00),null());
HXLINE( 189)				b8->writeString((HX_("",00,00,00,00) + port),null());
            			}
            		}
HXLINE( 192)		b8->writeString(request,null());
...
HXLINE( 196)				b8->writeString(HX_("&",26,00,00,00),null());
            			}
            			else {
HXLINE( 198)				b8->writeString(HX_("?",3f,00,00,00),null());
            			}
HXLINE( 199)			b8->writeString(uri,null());
            		}
HXLINE( 201)		b8->writeString(((HX_(" HTTP/1.1\r\nHost: ",d8,a9,d9,24) + host) + HX_("\r\n",5d,0b,00,00)),null());
...
HXLINE( 207)			b8->writeString(((HX_("Content-Length: ",20,de,22,7c) + this->postBytes->length) + HX_("\r\n",5d,0b,00,00)),null());
            		}
            		else {
HXLINE( 208)			bool _hx_tmp1;
HXDLIN( 208)			if (post) {
HXLINE( 208)				_hx_tmp1 = hx::IsNotNull( uri );
            			}
            			else {
...
HXLINE( 209)					_hx_tmp2 = !(::Lambda_obj::exists(this->headers, ::Dynamic(new _hx_Closure_0())));
            				}
            				else {
HXLINE( 209)					_hx_tmp2 = true;
            				}
HXDLIN( 209)				if (_hx_tmp2) {
HXLINE( 210)					b8->writeString(HX_("Content-Type: ",f4,2b,e6,1d),null());
HXLINE( 211)					if (multipart) {
HXLINE( 212)						b8->writeString(HX_("multipart/form-data",f0,f8,88,db),null());
HXLINE( 213)						b8->writeString(HX_("; boundary=",ee,f7,f2,1a),null());
HXLINE( 214)						b8->writeString(boundary,null());
            					}
            					else {
HXLINE( 216)						b8->writeString(HX_("application/x-www-form-urlencoded",9e,61,91,fa),null());
            					}
HXLINE( 217)					b8->writeString(HX_("\r\n",5d,0b,00,00),null());
            				}
HXLINE( 219)				if (multipart) {
HXLINE( 220)					b8->writeString(( (::String)(((HX_("Content-Length: ",20,de,22,7c) + (((uri.length + this->file->__Field(HX_("size",c1,a0,53,4c),hx::paccDynamic)) + boundary.length) + 6)) + HX_("\r\n",5d,0b,00,00))) ),null());
            				}
            				else {
HXLINE( 222)					b8->writeString(((HX_("Content-Length: ",20,de,22,7c) + uri.length) + HX_("\r\n",5d,0b,00,00)),null());
            				}
            			}
            		}
HXLINE( 224)		b8->writeString(HX_("Connection: close\r\n",31,73,d3,b4),null());
HXLINE( 225)		{
HXLINE( 225)			int _g3 = 0;
HXDLIN( 225)			::Array< ::Dynamic> _g12 = this->headers;
HXDLIN( 225)			while((_g3 < _g12->length)){
HXLINE( 225)				 ::Dynamic h1 = _g12->__get(_g3);
HXDLIN( 225)				_g3 = (_g3 + 1);
HXLINE( 226)				b8->writeString(( (::String)(h1->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)) ),null());
HXLINE( 227)				b8->writeString(HX_(": ",a6,32,00,00),null());
HXLINE( 228)				b8->writeString(( (::String)(h1->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) ),null());
HXLINE( 229)				b8->writeString(HX_("\r\n",5d,0b,00,00),null());
            			}
            		}
HXLINE( 231)		b8->writeString(HX_("\r\n",5d,0b,00,00),null());
HXLINE( 232)		if (hx::IsNotNull( this->postBytes )) {
HXLINE( 233)			b8->writeFullBytes(this->postBytes,0,this->postBytes->length);
            		}
            		else {
HXLINE( 234)			bool _hx_tmp3;
HXDLIN( 234)			if (post) {
HXLINE( 234)				_hx_tmp3 = hx::IsNotNull( uri );
            			}
            			else {
HXLINE( 234)				_hx_tmp3 = false;
            			}
HXDLIN( 234)			if (_hx_tmp3) {
HXLINE( 235)				b8->writeString(uri,null());
            			}
            		}
HXLINE( 236)		try {
...
HXLINE( 242)				this->writeBody(b8,( ( ::haxe::io::Input)(this->file->__Field(HX_("io",e6,5b,00,00),hx::paccDynamic)) ),( (int)(this->file->__Field(HX_("size",c1,a0,53,4c),hx::paccDynamic)) ),boundary,sock);
            			}
            			else {
HXLINE( 244)				this->writeBody(b8,null(),0,null(),sock);
            			}
...
HXLINE( 251)				 ::Dynamic _hx_tmp4 = this->onError;
HXDLIN( 251)				_hx_tmp4(::Std_obj::string(e));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
...
HXLINE( 290)					HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            				}
...
HXLINE( 299)						k = 4;
            				...
            				break;
            				case (int)2: {
HXLINE( 301)					int c1 = ( (int)(s->b->__get(1)) );
HXLINE( 302)					if ((c1 == 10)) {
...
HXLINE( 309)							k = 4;
            				...
            				break;
            				case (int)3: {
HXLINE( 311)					int c2 = ( (int)(s->b->__get(2)) );
HXLINE( 312)					if ((c2 == 10)) {
...
HXLINE( 320)								_hx_tmp1 = (s->b->__get(0) != 13);
            							}
            							else {
...
HXLINE( 325)							k = 4;
            				...
            				break;
            				case (int)4: {
HXLINE( 327)					int c3 = ( (int)(s->b->__get(3)) );
HXLINE( 328)					if ((c3 == 10)) {
...
HXLINE( 331)								_hx_tmp2 = (s->b->__get(0) != 13);
            							}
            							else {
...
HXLINE( 336)								_hx_tmp3 = (s->b->__get(1) != 13);
            							}
            							else {
...
HXLINE( 351)		bool _hx_tmp4;
HXDLIN( 351)		if (hx::IsNotEq( status,0 )) {
HXLINE( 351)			_hx_tmp4 = hx::IsNull( status );
            		}
            		else {
HXLINE( 351)			_hx_tmp4 = true;
            		}
HXDLIN( 351)		if (_hx_tmp4) {
HXLINE( 352)			HX_STACK_DO_THROW(HX_("Response status error",39,25,42,e1));
            		}
...
HXDLIN( 360)			while((_g2 < headers->length)){
HXLINE( 360)				::String hline = headers->__get(_g2);
...
HXLINE( 387)						goto _hx_goto_30;
            				...
            				if (_hx_e.IsClass<  ::haxe::io::Eof >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::haxe::io::Eof e = _hx_e;
HXLINE( 390)					HX_STACK_DO_THROW(HX_("Transfer aborted",3a,e2,d2,6a));
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
            				}
...
HXLINE( 397)						int len1 = sock->input->readBytes(buf,0,bufsize);
HXLINE( 398)						if ((len1 == 0)) {
HXLINE( 399)							goto _hx_goto_31;
            						}
HXLINE( 400)						api->writeBytes(buf,0,len1);
            					}
            					_hx_goto_31:;
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::haxe::io::Eof >() ){
...
HXLINE( 407)							len2 = bufsize;
            						}
            						else {
HXLINE( 407)							len2 = ( (int)(size) );
            						}
HXDLIN( 407)						int len3 = sock->input->readBytes(buf,0,len2);
HXLINE( 408)						api->writeBytes(buf,0,len3);
HXLINE( 409)						size = (size - len3);
            					}
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::haxe::io::Eof >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::haxe::io::Eof e2 = _hx_e;
HXLINE( 412)						HX_STACK_DO_THROW(HX_("Transfer aborted",3a,e2,d2,6a));
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
            					}
...
HXLINE( 415)				_hx_tmp5 = hx::IsNotNull( this->chunk_buf );
            			}
            			else {
HXLINE( 415)				_hx_tmp5 = true;
            			}
            		}
            		else {
...
HXLINE( 416)			HX_STACK_DO_THROW(HX_("Invalid chunk",64,90,fb,29));
            		}
HXLINE( 417)		bool _hx_tmp6;
HXDLIN( 417)		if (hx::IsGreaterEq( status,200 )) {
HXLINE( 417)			_hx_tmp6 = hx::IsGreaterEq( status,400 );
            		}
            		else {
HXLINE( 417)			_hx_tmp6 = true;
            		}
HXDLIN( 417)		if (_hx_tmp6) {
HXLINE( 418)			HX_STACK_DO_THROW((HX_("Http Error #",33,85,a5,2b) + status));
            		}
...
HXLINE( 427)						HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            					}
HXDLIN( 427)					::Array< unsigned char > b11 = b->b;
HXDLIN( 427)					::Array< unsigned char > b21 = buf->b;
HXDLIN( 427)					{
HXLINE( 427)						int _g2 = 0;
HXDLIN( 427)						int _g11 = len;
HXDLIN( 427)						while((_g2 < _g11)){
HXLINE( 427)							_g2 = (_g2 + 1);
HXDLIN( 427)							int i1 = (_g2 - 1);
HXDLIN( 427)							b->b->push(b21->__get(i1));
            						}
            					}
            				}
...
HXLINE( 460)			 ::sys::Http _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 460)			_hx_tmp1->chunk_size = (_hx_tmp1->chunk_size - len);
...
HXLINE( 476)		 ::sys::Http _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 476)		_hx_tmp2->chunk_size = (_hx_tmp2->chunk_size - len);
