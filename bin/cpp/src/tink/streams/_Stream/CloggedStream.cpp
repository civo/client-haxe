...
HX_DEFINE_STACK_FRAME(_hx_pos_9d4f3aed4a66aa58_168_new,"tink.streams._Stream.CloggedStream","new",0x71557231,"tink.streams._Stream.CloggedStream.new","tink/streams/Stream.hx",168,0x006f1625)
HX_LOCAL_STACK_FRAME(_hx_pos_9d4f3aed4a66aa58_177_forEach,"tink.streams._Stream.CloggedStream","forEach",0x246387fb,"tink.streams._Stream.CloggedStream.forEach","tink/streams/Stream.hx",177,0x006f1625)
namespace tink{
namespace streams{
namespace _Stream{

void CloggedStream_obj::__construct(::Dynamic rest, ::tink::core::TypedError error){
            	HX_STACKFRAME(&_hx_pos_9d4f3aed4a66aa58_168_new)
HXDLIN( 168)		super::__construct();
HXLINE( 169)		this->rest = rest;
HXLINE( 170)		this->error = error;
            	}
...
bool CloggedStream_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0e8c5e2e) {
		...
		return inClassId==(int)0x6164e307;
	}
}

::Dynamic CloggedStream_obj::forEach( ::Dynamic handler){
            	HX_GC_STACKFRAME(&_hx_pos_9d4f3aed4a66aa58_177_forEach)
HXDLIN( 177)		return  ::tink::core::_Future::SyncFuture_obj::__alloc( HX_CTX , ::tink::core::_Lazy::LazyConst_obj::__alloc( HX_CTX ,::tink::streams::Conclusion_obj::Clogged(this->error,this->rest)));
            	}
