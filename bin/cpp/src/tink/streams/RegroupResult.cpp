...
::tink::streams::RegroupResult RegroupResult_obj::Converted(::Dynamic data)
{
	return hx::CreateEnum< RegroupResult_obj >(HX_("Converted",f2,d8,8e,81),0,1)->_hx_init(0,data);
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(RegroupResult_obj,Converted,return)
...
{
	if (inName==HX_("Converted",f2,d8,8e,81)) return 1;
