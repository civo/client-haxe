...
class HXCPP_CLASS_ATTRIBUTES RegroupStream_obj : public  ::tink::streams::_Stream::CompoundStream_obj
{
	...
	public:
		enum { _hx_ClassId = 0x056405ce };

		void __construct(::Dynamic source, ::Dynamic f,::Dynamic prev);
		...
		static hx::ObjectPtr< RegroupStream_obj > __new(::Dynamic source, ::Dynamic f,::Dynamic prev);
		static hx::ObjectPtr< RegroupStream_obj > __alloc(hx::Ctx *_hx_ctx,::Dynamic source, ::Dynamic f,::Dynamic prev);
